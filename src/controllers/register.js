...
const controllerRegister = {
  ...
  listtheapprenticebyid: async (req, res) => {
    ...
    try {
      ...
      console.log(
        `Error al listar idaprendices en registros: ${apprentice}`,
        error
      );
      res
        .status(500)
  ...
  listregisterbymodality: async (req, res) => {
    ...
    try {
      ...
      console.log(
        `Error al listar modalidades en registros: ${idmodality}`,
        error
      );
      res.status(500).json({
        error: `Error al listar modalidades en registros ${idmodality}`,
      });
    }
  },
  ...
  addregister: async (req, res) => {
    ...
    try {
      ...
      res
        .status(500)
        .json({ success: false, error: "Error al insertar registro" }); // Manejo de errores
    }
  },
